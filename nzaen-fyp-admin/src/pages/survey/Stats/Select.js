...
export default function Select({ survey }) {
    ...
    const ratingOptions = survey.formdata
        .filter((element) => getElementFieldValue(element.id) === 'Select')
            ...
            {ratingOptions.map((option) => {
                ...
                return (
                    ...
                    <div key={`chart-${option}`} className='statSec'>
                        <h2>{String(getElementFieldQuestionEn(option))}<span className='type'>Select</span></h2>
